...
namespace STB.ADAOPS
{
	...
	public class DecalInGameManager : MonoBehaviour
	{
		...
		/// </summary>
		///////////////////////////////////////////////////////////////////////////////////////////////////////
		public GenericMeshDecal CreateNewMeshDecal (Material decalMaterial, Transform parent, Vector3 point, Vector3 normal, float scaleMultiplier, Vector2 rotationRange, bool attachDecalToCollisionObject,LayerMask layer)
		{			
			//print ("CreateNewDecal");

			GenericMeshDecal actualDecal = Instantiate (decalPrefab.gameObject).GetComponent<GenericMeshDecal> ();
            actualDecal.affectedLayers = layer;
